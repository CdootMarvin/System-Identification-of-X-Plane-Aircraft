...
fInput = fopen('Data172100ktslatdirdoubsandsweeps.txt', 'rt');
...
Pdoubail = ttest.Prad_s(23634:24085,:);
Rdoubail = ttest.Rrad_s(23634:24085,:);
phidoubail = ttest.rolldeg(23634:24085,:)*pi/180;
betadoubail = ttest.betadeg(23634:24085,:)*pi/180;
dadoubail=(ttest.Railn1deg(23634:24085,:)/2+(-1*ttest.Lailn1deg(23634:24085,:)/2))*pi/180; %da 172 +-15
drdoubail=ttest.rudr1deg(23634:24085,:)*pi/180; %dr 172 +-17
dtdoubail=ttest.thro1part(23634:24085,:);
% h=ttest.alt1ftmsl;
timedoubail=ttest.realtime(23634:24085,:);
...
Pdoubrud = ttest.Prad_s(32350:32842,:);
Rdoubrud = ttest.Rrad_s(32350:32842,:);
phidoubrud = ttest.rolldeg(32350:32842,:)*pi/180;
betadoubrud = ttest.betadeg(32350:32842,:)*pi/180;
dadoubrud=(ttest.Railn1deg(32350:32842,:)/2+(-1*ttest.Lailn1deg(32350:32842,:)/2))*pi/180; %da 172 +-15
drdoubrud=ttest.rudr1deg(32350:32842,:)*pi/180; %dr 172 +-17
dtdoubrud=ttest.thro1part(32350:32842,:);
% h=ttest.alt1ftmsl;
timedoubrud=ttest.realtime(32350:32842,:);
...
Q = ttest.Qrad_s(33900:38200);
P = ttest.Prad_s(33900:38200);
R = ttest.Rrad_s(33900:38200);
theta = ttest.pitchdeg(33900:38200)*pi/180-.44*pi/180;
phi = ttest.rolldeg(33900:38200)*pi/180;
alpha = ttest.alphadeg(33900:38200)*pi/180-.2*pi/180;
beta = ttest.betadeg(33900:38200)*pi/180;
vtrue = ttest.Vtruektas(33900:38200)*1.68781-172;
v=beta.*vtrue;
w=alpha.*vtrue;
U=sqrt(vtrue.^2-v.^2-w.^2);
de=ttest.elev1deg(33900:38200)*pi/180; % de 172 +-24°
de = de-1.029*pi/180;
da=(ttest.Railn1deg(33900:38200)/2+(-1*ttest.Lailn1deg(33900:38200)/2))*pi/180; %da 172 +-15
dr=ttest.rudr1deg(33900:38200)*pi/180; %dr 172 +-17
dt=ttest.thro1part(33900:38200);
% h=ttest.alt1ftmsl;
time=ttest.realtime(33900:38200);
timetot=ttest.totltime(33900:38200);
time = time - time(1);
...
%% 
timeplot = time(2388:end);
timeplot=timeplot-timeplot(1);

drplot = dr(2388:end);
figure, plot(timeplot,drplot)
cwt(drplot)
...
%% cwt chirp
figure, plot(trs,yrs(:,6))
trsplot = trs(2388:end);
trsplot = trsplot-trsplot(1);
drplot = yrs(:,6);
drplot = drplot(2388:end);
figure, plot(trsplot,drplot)
figure, cwt(drplot,fs)
...
%% OEM
% p0 = [-.4;-0.1;1;-.1;4;-16;2;-.5;-9;-.01;-.7;0.01;0;1;0;0;0;0;-60;-2;1;6;-.01;0];
...
%    p(9),p(10),p(11),p(12)
%    0,1,0,0];
% Boe = [p(17),p(18);p(19),p(20);p(21),p(22);0,p(24)];

Aoe = [-0.462929415078033,-0.00127545408658405,0.977278364141792,-0.182485115128969;5.10073768611778,-18.7420810083257,2.47078433269939,-0.571692430466839;-10.1932459390938,0.254854960169644,-0.790627450676251,-0.0797637143832767;0,1,0,0];

Boe = [0.000674352070973569,0.186671604936649;-81.7677620590389,-3.22048060868801;2.22184523921088,6.70526180560535;0,0.0866580360615605];
...
writetable(LonStab,'SkyHawk100KtsLatDirStabDerivs.xlsx','WriteRowNames',true)
